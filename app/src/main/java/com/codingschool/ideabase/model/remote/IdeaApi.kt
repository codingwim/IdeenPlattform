...
interface IdeaApi {
    ...
    // todo WithCatgories List<CatogryId>
    @GET("/idea")
    fun getAllIdeas(@Body withCategories: List<Category.id>): Single<List<Idea>>
    ...
    @PUT("/idea/{id}")
    fun updateIdea(@Path ("id") id: String, @Body updateIdea:  UpdateIdea): Single<Idea>
